...
I expect the log to the console ('Is the server started?') to be displayed first, listen() has a delay and is asynchronous so it should occur afterwards as console.log('Is the server started?') is not waiting on anything.
